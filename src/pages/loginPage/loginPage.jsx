...
import { logInToSite } from '../../services/actions/profileActions.js';
      ...
      {!authorizationRequest && !authorizationFailed && (
        <div className={style.container}>
          ...
          <p className='text text_type_main-default text_color_inactive'>Вы — новый пользователь? 
            <Link to='/register' className={`${style.link} ml-2 mb-4`} htmlType='button' type='secondary' size='large'>Зарегистрироваться</Link>
          </p>
          <p className='text text_type_main-default text_color_inactive'>Забыли пароль? 
            <Link to='/forgot-password' className={`${style.link} ml-2`} htmlType='button' type='secondary' size='large'>Восстановить пароль</Link>
          </p>
